...
public class GlobalExceptionHandler {
    ...
    /**
     * CP_02/04/05/06 (IllegalArgumentException từ orElseThrow "Reservation not found")
     * CP_08 (IllegalArgumentException từ CheckpointType.valueOf khi type không hợp lệ)
